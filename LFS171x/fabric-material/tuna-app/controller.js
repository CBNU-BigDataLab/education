...
return{
	get_all_product: function(req, res){
	...
	get_all_product_by_type: function(req, res){
		console.log("getting all products from database by type: ");
		var product_type = req.params.product_type
	...
	add_product: function(req, res){
		console.log("submit recording of a product catch: ");

		var array = req.params.product.split("-");
		console.log(array);

		var key = array[0]
		var producing_area = array[1]
		var product_type = array[2]
		var product_unit = array[3]
		var unit_price = array[4]
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        chaincodeId: 'tuna-app',
		        fcn: 'recordProduct',
		        args: [key, producing_area, product_type, product_unit, unit_price, quantity, timestamp, holder],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
	...
	change_holder: function(req, res){
		console.log("changing holder of product catch: ");
